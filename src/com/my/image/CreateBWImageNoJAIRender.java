...
public class CreateBWImageNoJAIRender {
	...
	public static void main(String[] args) throws IOException {
		// Read an image.
		BufferedImage input = ImageIO.read(new File("/Users/karan.verma/Documents/Photograph.jpg"));
		...
		ImageIO.write(im, "PNG", new File("/Users/karan.verma/Documents/rendered.png"));
